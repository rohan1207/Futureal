...
${formData.message}`;
  ...
  return (
    <div className=" lg:mt-[86px] px-4 sm:px-8">
      ...
      <div className="flex gap-4 mb-4">
        <button
          className={`w-[158px] h-[42px] border-2 rounded-lg flex justify-center items-center text-sm md:text-base ${
            !isWhatsApp ? "bg-gradient-to-br from-[#2A72F8] to-[#8F44EC] text-white text-white" : "bg-gray-300 text-black"
          }`}
      ...
      >
        ...
        {isWhatsApp ? (
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-br from-[#2A72F8] to-[#8F44EC] text-white text-white py-2 rounded-lg hover:bg-[#007BFF] transition"
          >
            Send Email
          </button>
        )}
